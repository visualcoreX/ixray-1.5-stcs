...
//////////////////////////////////////////////////////////////////////////
// Attack On Move -- the Call of Pripyat charge behaviour.
// The monster runs at the enemy (go_close), hits it on the run without
// stopping, then loops out and comes back for another pass (go_prepare).
//////////////////////////////////////////////////////////////////////////
...
private:
	...
	enum aim_side {
		left	= 0,
		right	= 1
	};	// coupled with m_animation_index[]
	...
	u32					m_animation_index[2];
	float				m_animation_hit_time[2];
	...
	const CEntityAlive	*m_enemy_to_attack;
...
private:
	...
	void				choose_next_attack_animation();
