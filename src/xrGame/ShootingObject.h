...
protected:
	...
	//�������� ����
public:
	// gwr: the burning-actor phantom lights its own hands from outside (see gwr_update_burning);
	// Gunslinger reaches for this the same way. Idempotent -- it no-ops while already looping.
