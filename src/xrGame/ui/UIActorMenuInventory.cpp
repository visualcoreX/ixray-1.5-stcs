...
void CUIActorMenu::PropertiesBoxForAddon( PIItem item, bool& b_show )
{
	...
	// e.g. "Прикрепить глушитель к АК-74М"), offered for either weapon slot (both are interchangeable
	// now, and the concrete name distinguishes them). The prefix key holds "Прикрепить <addon> к".
