...
void CHW::updateWindowProps(HWND m_hWnd)
{
	...
	{
		// Borderless: still an ordinary windowed swap chain -- no exclusive mode, so alt-tab is
		// instant and the desktop resolution is left alone -- but drawn with no caption and no
		// frame, sized exactly to the chosen resolution and centred on the desktop.
		// (Twin of the same block in xrRender\HW.cpp.)
